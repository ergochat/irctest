...
class RegisteredOnlySpeakMode(cases.BaseServerTestCase):
    ...
    def testRegisteredOnlySpeakMode(self):
        ...
        replies = self.getMessages("chanop")
        self.assertMessageMatch(replies[0], command='PRIVMSG', params=['#chan', 'hi again from baz'])
        ...
        self.assertEqual(replies, [])
        replies = self.getMessages("baz")
        self.assertMessageMatch(replies[0], command='PRIVMSG', params=['#chan', 'hi from evan'])
